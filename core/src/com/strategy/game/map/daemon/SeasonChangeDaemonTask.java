...
public class SeasonChangeDaemonTask extends TimerTask {
    ...
    public SeasonChangeDaemonTask(TileChange tileChange, ForestChange forestChange, GrassChange grassChange) {
    ...
    public void run() {
        ...
        grassChange.nextGrassGrowsIter(currentSeason, currentIter);
        if (yearCount == 4) {
            year++;
            yearCount = 0;
        }
